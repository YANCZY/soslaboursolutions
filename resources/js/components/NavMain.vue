...
<template>
    <SidebarGroup class="px-2 py-0">
        <div v-if="items.length > 0" class="flex items-center gap-3 px-2">
        ...
        <div v-if="(peopleItems ?? []).length > 0" class="mt-4 flex items-center gap-3 px-2">
            <div class="h-px w-4 bg-sidebar-border/70" />
            <SidebarGroupLabel class="h-auto shrink-0 px-0">
                People
            </SidebarGroupLabel>
        ...
        <SidebarMenu>
         ...
         <div v-if="(workspaceItems ?? []).length > 0" class="mt-4 flex items-center gap-3 px-2">
            <div class="h-px w-4 bg-sidebar-border/70" />
            <SidebarGroupLabel class="h-auto shrink-0 px-0">
                Workspace
            </SidebarGroupLabel>
       ...
       <SidebarMenu v-if="(workspaceItems ?? []).length > 0">
            <SidebarMenuItem
